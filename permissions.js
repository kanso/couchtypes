...
function (exports, utils, _) {
     ...
     * @param {Boolean} disallow_admin - whether users with _admin role should
     *                                   be also be prevented from editing the
     *                                   field
     * @returns {Function}
     * @api public
     */
    ...
    /**
     * User's name should match the *old* value of the given field. A field can
     * be specified using a string or an array of strings (like a path).
     *
     * <pre>
    ...
    /**
     * Treat new and old values like new documents of a given type, and attempt
     * to authorize the value against the type's permissions. Useful when
     * handling permissions for an embedded type.
     *
