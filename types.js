...
function (exports, utils, fields, fieldset, widgets, permissions, db, _) {
     ...
     * * **display_name** *Function|String|Array* - name to be used when
     *                    displaying the document in the admin tool. A string
     *                    or array will become the property to display. A
     *                    function should take the document as a object and
     ...
     * providing a new _id value. This is a convenient function to use when
     * creating a type to embed within another.
     *
    ...
    Type.prototype.create = function (userCtx, callback) {
        ...
        // TODO: replace with jQuery.ajax call
     ...
     * This should be called from your app's exported validate_doc_update
     * function if you wish to use kanso Types in you project.
     *
     * Throws on error.
     *
