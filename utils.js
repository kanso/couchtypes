...
define(['exports', 'underscore'], function (exports, _) {
     ...
     * Returns the value of the matched path, or undefined if the property does
     * not exist.
     *
     * If a string if used for the path, it is assumed to be a path with a
     * single key (the given string).
     *
     * <pre>
    ...
    /**
     * Returns attachments below a given path from a document, returning an
     * object with the attachment names relative to that path. Example:
     *
