...
function (exports, sanitize, session, db, _) {
    ...
    /**
     * Converts a widget to HTML using the provided name and parsed and raw
     * values
     *
    ...
    exports.creator = function (options) {
        ...
        var el; // store reference to element so we can detect when its been
                // removed
            ...
            if (options.operation === 'add') {
                ...
                var update_val = function (userCtx, req) {
                    ...
                    if (container) {
                        ...
                        // element has been removed from page (or was never
                        // there?)
                        session.removeListener('change', update_val);
                    }
                };
