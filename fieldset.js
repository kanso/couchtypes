...
function (exports, utils, fields_module, _) {
     ...
     * @param {Object} fields
     * @param {Object} req - the request object to pass to default_value
     *                       functions
     * @returns {Object}
     * @api public
     */
    ...
    /**
     * Validate a specific field, returning all validation errors as an array
     * with each error's field property prefixed by the current path.
     *
    ...
    /**
     * Validates an object containing fields or other sub-objects, iterating
     * over each property and recursing through sub-objects to find all Fields.
     *
     * Returns an array of validation errors, each with a field property set to
     * the path of the field which caused the error.
     *
     ...
     * @param {Object} raw
     * @param {Array} path
     * @param {Boolean} extra - whether to allow extra values not covered by a
     *                          field
     * @returns {Array}
     * @api public
     */
    ...
    exports.validate = function (fields, doc, values, raw, path, extra) {
        ...
        // Ensure we walk through all paths of both fields and values by
        // combining the keys of both. Otherwise, we might miss out checking
        // for missing required fields, or may not detect the presence of extra
        // fields.
    ...
    /**
     * Authorize a specific field, returning all permissions errors as an array
     * with each error's field property prefixed by the current path.
     *
    ...
    /**
     * Authorizes an object containing fields or other sub-objects, iterating
     * over each property and recursing through sub-objects to find all Fields.
     *
     * Returns an array of permissions errors, each with a field property set
     * to the path of the field which caused the error.
     *
